...
* @returns {any}
*/
module.exports.get_routing_locations = function(problem) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_routing_locations(retptr, addHeapObject(problem));
...
* @returns {any}
*/
module.exports.validate_pragmatic = function(problem, matrices) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.validate_pragmatic(retptr, addHeapObject(problem), addHeapObject(matrices));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @returns {any}
*/
module.exports.convert_to_pragmatic = function(format, inputs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.convert_to_pragmatic(retptr, ptr0, len0, addHeapObject(inputs));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @returns {any}
*/
module.exports.solve_pragmatic = function(problem, matrices, config) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.solve_pragmatic(retptr, addHeapObject(problem), addHeapObject(matrices), addHeapObject(config));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
const path = require('path').join(__dirname, 'vrp_cli_bg.wasm');
